...
public abstract class MirrorSharpRoslynOptions<TSelf, TParseOptions, TCompilationOptions> : IRoslynLanguageOptions
    ...
    ///     Host object type for the session; must be <c>null</c> if <paramref name="isScript" /> is
    ///     <c>false</c>.
    /// </param>
    ...
    /// <summary>
    ///     Adds assembly references to <see cref="MetadataReferences" /> and attempts to discover corresponding XML
    ///     documentation.
    /// </summary>

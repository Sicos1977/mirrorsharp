...
public static class FSharpProjectOptionsExtensions {
    ...
    /// <returns>
    ///     Either a new instance of <see cref="FSharpProjectOptions" /> with the option changed; or
    ...
    /// <returns>
    ///     Either a new instance of <see cref="FSharpProjectOptions" /> with <see cref="FSharpProjectOptions.OtherOptions" />
    ///     set;
